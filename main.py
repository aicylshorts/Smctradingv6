        ...
        for symbol in ALL_SYMBOLS:
            try:
                ...
                for tf_key, df in mtf_data.items():
                    ...
                    # Uses symbol + timeframe + direction + score + full timestamp to prevent duplicates
                    sig = symbol + "_" + tf_key + "_" + setup.direction + "_" + str(setup.score) + "_" + setup.timestamp.strftime('%Y%m%d%H%M')
